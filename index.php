            ...
            <div class="row">
                ...
                <div class="booking-form">
                    ...
                    <div class="row justify-content-center">
                            <div class="col-4">
                                <span><a href="./index.php" class="btn btn-warning btn-lg">Maintenance</a></span>
                            </div>
                            <div class="col-4">
                        ...
                        <hr>
                        <h1>Maintenance Service - CJ</h1>
                    </div>
                    <form action="./maintenance.php" method="POST" enctype="multipart/form-data">   <!--ประกาศให้ Form นี้ทำงานจาก create.php-->
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input class="form-control" type="text" id="place" name="place" placeholder="Place - สถานที่" require>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="form-label">Service Date - วันที่ต้องการรับบริการ</span>
                                </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                <input class="form-control" type="text" id="issue" name="issue" placeholder="Issue - ปัญหาที่พบ" require>
                                </div>
                            </div>
                        </div>
                        <div class="row">
