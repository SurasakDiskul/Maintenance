...
$remark = $_POST['issue'];
    ...
    if(move_uploaded_file($_FILES['issue_img']['tmp_name'],$path_copy)){
        ...
        $sql1 = "INSERT INTO `tbsafety`(`membername` ,`date` , `place`, `issue_img`, `safety`, `ststatus`) 
        VALUES (
                    '".$_POST['membername']."', 
                    '".$_POST['startdate']."', 
                    '".$_POST['place']."',
                    ...
                    if (mysqli_query($conn, $sql1)) { // if check ว่า insert ข้อมูลสำเร็จหรือไม่
                        ...
                        $sMessage = "แผนก $dept ได้มีการส่งรายงาน\n";
                        $sMessage .= "Safety & Clean $place\n";
                        $sMessage .= "บริเวณที่ดำเนินการ $remark\n";
