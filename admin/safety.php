...
<body>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    ...
                    <h4 class="user-name dropdown-toggle">Safety - HR</h4>
                </div>
            </div>
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li  class="active"><a href="./safety.php">ถังดับเพลิง</a></li>
                                </ul>
                            </li>
                            <li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Safety</h4>
      ...
      <div class="row">
                  ...
                  <div class="modal fade" id="my-modal<?php echo $row['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="row gy-4" action="./safety_db.php" method="POST" enctype="multipart/form-data">
        ...
        <br>
        <div class="col-12">
        <h2>Safety List ( Fully Complete )</h2>
        <hr>
          <div class="card mb-4">
            <div class="p-1">
