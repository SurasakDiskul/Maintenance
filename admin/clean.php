...
<body>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    ...
                    <h4 class="user-name dropdown-toggle">Clean - HR</h4>
                </div>
            </div>
                    ...
                    <nav> 
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="./clean.php">2ส บริษัท - บ้านพักพนักงาน</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Clean</h4>
      ...
      <div class="row">
        ...
        <hr>
          <div class="card mb-4">
            ...
            <div class="card-body px-20 pt-20 pb-20">
              ...
              <?php 
                    $i = 1;
                    $sql = "SELECT * FROM `tbsafety` where ststatus !='Fully Complete' and place != 'ถังดับเพลิง' limit 20";
                  ...
                  <div class="modal fade" id="my-modal<?php echo $row['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="row gy-4" action="./clean_db.php" method="POST" enctype="multipart/form-data">
                                ...
                                <p class="text-center"><b>Date :</b> <?php echo $row['date'] ?></p>
                                <p class="text-center"><b>Safety :</b> <?php echo $row['safety'] ?></p>
                                <hr>
                            ...
                            <div class="modal-footer">
                               <div class="row">
                                <input type="text" class="form-control text-center" id="status" name="status" value="<?php echo $row['ststatus'] ?>" readonly>
                                </div>
        ...
        <br>
        <div class="col-12">
        <h2>Clean List ( Fully Complete )</h2>
        <hr>
          <div class="card mb-4">
            <div class="p-1">
            ...
            <div class="card-body px-20 pt-20 pb-20">
              ...
              <?php 
                    $i = 1;
                    $sql = "SELECT * FROM `tbsafety` where ststatus ='Fully Complete' and place != 'ถังดับเพลิง' order by id DESC limit 20";
                    $result = mysqli_query($conn,$sql);
                ?>
